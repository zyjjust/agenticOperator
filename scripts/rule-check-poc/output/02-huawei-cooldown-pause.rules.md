# RULES 段 — 02-huawei-cooldown-pause

**Candidate**: 李四 — Frontend,1.5 个月前从华为离职 (3 月冷冻期内)
**Job Requisition**: 腾讯 PCG 高级前端 (jr_x99)
**Dimensions**: client=`腾讯`, business_group=`PCG`, studio=`—`
