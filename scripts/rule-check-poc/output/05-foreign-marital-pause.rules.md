# RULES 段 — 05-foreign-marital-pause

**Candidate**: 周七 — 数据分析师,美籍华人,28 岁未婚女性
**Job Requisition**: 腾讯 CDG 数据分析师 (jr_y88)
**Dimensions**: client=`腾讯`, business_group=`CDG`, studio=`—`

**Rules after filter**: 27 / 51
- 通用 (CSI): 17
- 客户级 (腾讯): 8
- 部门级 (CDG / —): 2
