# RULES 段 — 03-csi-blacklist-drop

**Candidate**: 王五 — Java 后端,前华腾员工,离职编码 B8 (有犯罪记录-YCH)
**Job Requisition**: 腾讯 IEG 后台 Java 工程师 (jr_v55)
**Dimensions**: client=`腾讯`, business_group=`IEG`, studio=`—`
