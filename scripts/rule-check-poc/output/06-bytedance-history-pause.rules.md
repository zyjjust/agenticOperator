# RULES 段 — 06-bytedance-history-pause

**Candidate**: 钱八 — Frontend,前字节跳动正式员工,2 年前主动离职
**Job Requisition**: 字节 TikTok 海外 Web 前端 (jr_w66)
**Dimensions**: client=`字节`, business_group=`TikTok`, studio=`—`

**Rules after filter**: 28 / 51
- 通用 (CSI): 17
- 客户级 (字节): 11
- 部门级 (TikTok / —): 0
